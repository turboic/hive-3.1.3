...
public class SparkCounter implements Serializable {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(SparkCounter.class);
  ...
  public SparkCounter(
    ...
    LOG.info("name ==== {},displayName ==== {},groupName ==== {},initValue ==== {}",name,displayName,groupName,initValue);
