...
public class ShuffleWriteMetrics implements Serializable {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ShuffleWriteMetrics.class);
    ...
    public ShuffleWriteMetrics(long shuffleBytesWritten, long shuffleWriteTime) {
        LOG.info("ShuffleWriteMetrics param shuffleBytesWritten = {},shuffleWriteTime ==== {}", shuffleBytesWritten, shuffleWriteTime);
