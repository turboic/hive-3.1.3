...
public class KryoSerializer {
  ...
  public static byte[] serialize(Object object) {
    ...
    LOG.error("Kryo class Loader from ==== {}",cs.getLocation());

    java.security.ProtectionDomain pd2 = net.jpountz.lz4.LZ4BlockInputStream.class.getProtectionDomain();
    CodeSource cs2 = pd2.getCodeSource();

    LOG.error("net.jpountz.lz4.LZ4BlockInputStream class Loader from ==== {}",cs2.getLocation());
